...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE crawl SET title=%s, `description`=%s, keywords=%s, content=%s, block_update=%s WHERE id=%s",
                       ...
                       GetSQLValueString(addslashes($_POST['content']), "text"),
                       GetSQLValueString(isset($_POST['block_update']) ? "true" : "", "defined","'Y'","'N'"),
...
-->
        ...
        Update Crawled Data</legend>
                                 ...
                                 <label style="clear:both;">Title </label>
                                   ...
                                   <input name="title" type="text" class="form-control input-lg" placeholder="Title"  value="<?php echo str_replace("\"","",stripslashes($row_selectedCrawl['title'])); ?>"  />
                                   
                                    <br>

                                 <label style="clear:both;">Description </label>
                                 
                                   <textarea name="description" class="form-control input-lg" id="description" placeholder="Description"><?php echo str_replace("\"","",stripslashes($row_selectedCrawl['description'])); ?></textarea>
                                     
                                     
                                   
<br>
                                 <label style="clear:both;">Keywords</label>
                                 
                                   <textarea name="keywords" class="form-control input-lg" id="keywords" placeholder="Keywords"><?php echo str_replace("\"","",stripslashes($row_selectedCrawl['keywords'])); ?></textarea>
                                     
                                     
                                   
<br>
                                  <label style="clear:both;">Content </label>
                                 
                                    <textarea name="content" rows="10" class="form-control input-lg" id="content" placeholder="Contents"><?php echo str_replace("\"","",stripslashes($row_selectedCrawl['content'])); ?></textarea>
                                     
                                     
                                  
<?php if (!(strcmp($row_selectedCrawl['manual'],"N"))) {?>
                                <label style="clear:both;">Block Update
                                 <input <?php if (!(strcmp($row_selectedCrawl['block_update'],"Y"))) {echo "checked=\"checked\"";} ?> name="block_update" type="checkbox" id="block_update" value="Y" class="form-control input-lg" style="width:50px;">
<span class="badge badge-warning">Updated Data will be replaced by updated data from link in future crawling if "Block Update" is not selected.</span>
                                 </label>
<?php }else{?>                                 
 <input name="block_update" type="hidden" id="block_update" value="Y">
 <?php }?>                                
