...
mysqli_select_db($saha, $database_saha);$query_selected = "SELECT * FROM settings ORDER BY settings.id DESC";
$selected = mysqli_query($saha, $query_selected) or die(mysqli_error($saha));
$row_selected = mysqli_fetch_assoc($selected);
$totalRows_selected = mysqli_num_rows($selected);
...
mysqli_select_db($saha, $database_saha);$query_tablelist = "SELECT * FROM settings ORDER BY settings.id DESC LIMIT 300";
						...
						<div class="col-md-12">
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th>Added on</th>
                                    <th>Spide Mode <input type="button" name="button2" id="button2" value="Back" class="btn btn-warning"  style="width:100px; float:right;" onClick="window.location='admin-crawl.php';"></th>
                                    <th width="50"><input type="submit" name="button" id="button" value="Start Crawling" class="btn btn-primary"  style="width:150px;"></th>
                                </tr>
                            </thead>
                            <tbody>
<?php $i=0;?>                            
...
?>                                
                                <tr>
                                    ...
                                    <td>
                                    <input name="checkbox<?php echo $i; ?>" type="checkbox" id="checkbox<?php echo $i; ?>" value="<?php echo $row_tablelist['id']; ?>" class="form-control" />
                                    </td>
                                </tr>
