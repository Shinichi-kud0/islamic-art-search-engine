...
if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form")) {
  $updateSQL = sprintf("UPDATE crawl_images SET keywords=%s, block_update=%s WHERE id=%s",
...
mysqli_select_db($saha, $database_saha);$query_selectedCrawl = "SELECT * FROM crawl_images WHERE crawl_images.id='$id'";
...
-->
        ...
        Update Crawled Image</legend>
                                ...
                                <label style="clear:both;">Keywords</label>
                                   ...
                                   <textarea name="keywords" class="form-control input-lg" id="keywords" placeholder="Keywords"><?php echo $row_selectedCrawl['keywords']; ?></textarea>
