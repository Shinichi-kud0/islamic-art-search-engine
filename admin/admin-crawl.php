...
mysqli_select_db($saha, $database_saha);$query_CrawlPending = "SELECT * FROM settings WHERE settings.crawlRun='Y'";
...
mysqli_select_db($saha, $database_saha);$query_CrawlPendingT = "SELECT * FROM settings";
...
mysqli_select_db($saha, $database_saha);$query_CrawlIPendingT = "SELECT * FROM crawl";
