...
$totalRows_selectedCrawl = mysqli_num_rows($selectedCrawl);
	    ...
	    $insertSQL = sprintf("INSERT INTO crawl (current_url, actual_url, base_url, manual, title, description, keywords, content, block_update) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s)",
...
-->
            ...
            <div class="clients-list">
                              ...
                              <fieldset>
                              <legend><a href="<?php echo $_SERVER['HTTP_REFERER']; ?>" class="btn btn-primary">Go Back</a> New Manual  Data</legend>
                                 <div class="form-group">
                                   <label for="actual_url">Page / URL</label>
...
?>
                                   ...
                                   <label style="clear:both;">Manual URL </label>
                                   ...
                                   <input name="title" type="text" class="form-control input-lg" placeholder="Title"  value=""  />
                                   

                                 <label style="clear:both;">Description </label>
                                 
                                   <textarea name="description" class="form-control input-lg" id="description" placeholder="Description"></textarea>
...
<br>
                                  <label style="clear:both;">Content </label>
                                    ...
                                    <textarea name="content" rows="10" class="form-control input-lg" id="content" placeholder="Contents"></textarea>
