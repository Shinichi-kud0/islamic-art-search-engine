...
mysqli_select_db($saha, $database_saha);$query_total = "SELECT * FROM crawl WHERE crawl.actual_url='$actual_url' ";
...
mysqli_select_db($saha, $database_saha);$query_selectedCrawl = "SELECT * FROM crawl WHERE crawl.actual_url='$actual_url' ORDER BY crawl.visits DESC LIMIT $stt,$lim";
...
mysqli_select_db($saha, $database_saha);$query_selectedCrawlImage = "SELECT * FROM crawl_images WHERE crawl_images.current_url= '$SRC'";
