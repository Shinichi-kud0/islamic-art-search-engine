...
<?php }?>
                                            ...
                                            <td class="client-status" colspan="4"><a href="admin-data-new.php" class="btn btn-success btn-lg">Manual URL</a></td>
                                          </tr>
                                          <tr>
                                            <td>Title</td>
                                                  <td>URL</td>
                                                  <td>Total Visits</td>
                                                  <td class="client-status">Images</td>
...
URL : <a href="<?php echo $row_selected['current_url']; ?>" target="_blank" class="client-link" data-toggle="tab"><?php echo $row_selected['current_url']; ?></a>
                                                   ...
                                                   <td class="client-status"><a href="admin-data-update.php?id=<?php echo $row_selected['id']; ?>" class="btn btn-primary">Update</a></td>
                                                   <td class="client-status"> 
<?php if($row_selected['deleted']=="Y"){?>
<a href="admin-data-delete.php?id=<?php echo $row_selected['id']; ?>&deleted=N"  class="btn btn-warning">Un-Delete</a>
<?php }else{?>
<a href="admin-data-delete.php?id=<?php echo $row_selected['id']; ?>&deleted=Y"  class="btn btn-danger">Delete</a>
