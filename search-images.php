                           ...
                           <div class="search-form">
                             <form action="" method="get">
                                 <div class="input-group">
                                    <input type="text" placeholder="Search Web" name="q" class="form-control input-lg" value="<?php echo stripslashes(@$cid); ?>">
...
<?php if(@$totalRows_searchResults>0){?>                           
                           ...
                           <?php }else{?>
                              <?php echo $totalRows_total; ?> results found for: <span class="text-navy">“<?php echo stripslashes(@$cid); ?>”</span>.
                              <?php }?>
                           </h2>
...
<a href="<?php echo $row_searchResults['image_url']; ?>" target="_blank"><img src="piccrop.php?w=250&img=<?php echo base64_encode($row_searchResults['image_url']); ?>" class="image"></a>
