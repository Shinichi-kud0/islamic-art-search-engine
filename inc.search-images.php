...
mysqli_select_db($saha, $database_saha);$query_total = "SELECT * FROM crawl_images WHERE crawl_images.deleted='N' AND (crawl_images.current_url LIKE '%$cid%'  OR crawl_images.keywords LIKE '%$cid%')";
...
mysqli_select_db($saha, $database_saha);$query_searchResults = "SELECT * FROM crawl_images WHERE crawl_images.deleted='N' AND (crawl_images.current_url LIKE '%$cid%'  OR crawl_images.keywords LIKE '%$cid%') LIMIT $stt,$lim";
