...
mysqli_select_db($saha, $database_saha);$query_total = "SELECT * FROM crawl WHERE crawl.deleted='N'";
...
mysqli_select_db($saha, $database_saha);$query_searchResults = "SELECT * FROM crawl WHERE crawl.deleted='N' ORDER BY crawl.id DESC LIMIT $stt,$lim";
